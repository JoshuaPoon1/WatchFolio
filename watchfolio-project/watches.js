class watch {
  ...
  let watches = [
  new watch(105000, 2023, -1.10, -3.0, 8.23, "Nautilus Moonphase", "Patek Philippe", "5726/1A"), //check
  ...
  new watch(51000, 2022, -1.5, -2.1, -5.8, "Royal Oak 50th", "Audemars Piguet", "15510ST"), //check
  new watch(22300, 2020, -1.5, -2.8, -6.1, "Silver Snoopy Award Speedmaster ", "Omega","310.32.42.50.02.001"), // check
  new watch(22100, 2023, -2.8, -3.5, -8.2, "Rolex GMT-Master II PEPSI", "Rolex","126710BLRO"), //check
  new watch(14800, 2023, 1.70, -3.22, 17.54,"Blue Dial Milguass","Rolex","116400GV"), //check
  new watch(6100, 2019, -3.0, -4.8, -9.1, "Santos Large Blue Dial", "Cartier","WSSA0030"), //check
  new watch(23000, 2022, 0.2, 1.4, 4.0, "Submariner Green", "Rolex","116610LV"),
  new watch(6843,2022,1.45,3.54,24.43,"Seamaster Toyko Edition","Omega","522.30.42.20.04.001"),
  new watch(13600, 2023, 1.8,2.1, 85.8, "Datejust Palm Dial", "Rolex","126200"),
  ];
